...
Put '**{model name}.data**', '**{model name}.pb**' into `app/src/main/assets`, the model files are generated by XGen toolchain.

![](images/location_of_data_and_pb.png)

Then you can modify `app/src/main/com/cocopie/xgen/yolo/example/Yolox.kt`, change the model name and label name.

![](images/yolox.png)

Put '**libxgen.so**' into `app/src/main/jniLibs/arm64-v8a`.
